...
<body>
    ...
    include 'koneksi.php';
    $nomor = $_GET['nomor'];
    $query = "SELECT * FROM siswa WHERE nomor = '$nomor'";
                ...
                <div class="card-body">
                    <form action="prosesedit.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="nomor" type="text" class="form-control" name="nomor" placeholder="Masukkan nomor induk siswa" required value="<?= $data['nomor'] ?>" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="nilai" type="text" class="form-control" name="nilai" placeholder="Masukkan nilai" required value="<?= $data['nilai'] ?>">
                        </div>
